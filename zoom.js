document.addEventListener('DOMContentLoaded', function () {
  ...
  // Only set up image zoom if overlay exists
  ...
  // Always run animation init, separate from zoom logic
  runIntelMapAnimation();
});

function runIntelMapAnimation() {
  // CSS-only animation is handled in styles.css
  console.log('[INTEL-MAP] CSS animation active; script fallback disabled.');
}
